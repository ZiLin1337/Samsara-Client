...
import cc.samsara.module.impl.client.DebugModule;
import cc.samsara.module.impl.client.IrcModule;
import cc.samsara.module.impl.client.RadioModule;
import cc.samsara.module.impl.client.RotationsModule;
import cc.samsara.module.impl.client.cheaterfinder.CheaterFinderModule;
import cc.samsara.module.impl.combat.*;
import cc.samsara.module.impl.combat.backtrack.BackTrackModule;
import cc.samsara.module.impl.exploit.*;
import cc.samsara.module.impl.movement.*;
import cc.samsara.module.impl.player.*;
import cc.samsara.module.impl.visual.*;
import cc.samsara.module.impl.world.*;
...
public class ModuleManager extends Manager<cc.samsara.module.Module> {
    public void registerModules() {
        List<cc.samsara.module.Module> modules = new ArrayList<>(Arrays.asList(
                new KillauraModule(),
        ...
        if ((Flags.isNotAuthenticated ||
            ...
            for (int i = 0; i <= modules.size() - 1; i++) {
                register((cc.samsara.module.Module) null);
            }
            ...
            for (cc.samsara.module.Module module : modules) {
    ...
    public <T extends cc.samsara.module.Module> T getModule(final Class<T> clazz) {
        return (T) this.getBy(module -> Objects.equals(module.getClass(), clazz));
    }

    @SuppressWarnings("unchecked")
    public <T extends cc.samsara.module.Module> T getModule(String name) {
    ...
    @SuppressWarnings("unchecked")
    public <T extends cc.samsara.module.Module> T getModuleBySimplifiedName(String name) {
        return (T) getObjects().stream()
    ...
    public List<cc.samsara.module.Module> getModules() {

...
import cc.samsara.util.math.MathUtil;
...
public class TargetStrafeModule extends Module {
    ...
    public void onUpdate(MoveEvent event) {
        ...
        final SpeedModule speedModule = Samsara.getInstance().getModuleManager().getModule(SpeedModule.class);
        final FlightModule flightModule = Samsara.getInstance().getModuleManager().getModule(FlightModule.class);

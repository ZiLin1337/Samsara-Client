package cc.samsara.module.impl.movement.longjump;
...
public class WatchdogFireBall extends SubModule {
    ...
    public void onEnable() {
        ticks = 0;
        if (Samsara.getInstance().getModuleManager().getModule(VelocityModule.class).isToggled()) {
            Samsara.getInstance().getModuleManager().getModule(VelocityModule.class).setToggled(false);
    ...
    public void onDisable() {
        if (!Samsara.getInstance().getModuleManager().getModule(VelocityModule.class).isToggled()) {
            Samsara.getInstance().getModuleManager().getModule(VelocityModule.class).setToggled(true);
        }

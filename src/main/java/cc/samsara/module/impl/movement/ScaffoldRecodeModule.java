...
import static cc.samsara.module.impl.movement.ScaffoldWalkModule.wrapTo90;
import static cc.samsara.util.player.scaffold.ScaffoldWalkUtil.getBlockStateRelativeToPlayer;
...
public class ScaffoldRecodeModule extends Module {
    ...
    private final ModeProperty rayCastMode = new ModeProperty("Raycast Mode", "None", "Minecraft", "Samsara", "Normal", "None");
    private final ModeProperty rotSpeed = new ModeProperty("Rotation Speed", "Fast", "Fast", "Normal", "Slow");
    private final ModeProperty bypassMode = new ModeProperty("Bypass Mode", "Telly", "Telly", "Telly Slow", "Samsara");

...
import cc.samsara.util.render.BlockUtil;
...
public class AnimationModule extends Module {
    public static ModeProperty animationMode = new ModeProperty("Animation Mode", "1.8", "1.8", "1.7", "Swang", "Lunar", "Bouncy", "Slide", "Slide 2", "Slide 3", "Samsara", "Swank");

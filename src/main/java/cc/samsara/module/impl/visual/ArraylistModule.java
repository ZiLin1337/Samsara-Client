...
public class ArraylistModule extends Module {
    ...
    private void rebuildModules() {
        var hud = Samsara.getInstance().getModuleManager().getModule(HudModule.class);
        ...
        moduleEntries = Samsara.getInstance().getModuleManager().getModules().stream()
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        for (ModuleEntry entry : moduleEntries) {
            ...
            Animation animation = Samsara.getInstance().getAnimationManager().getAnimation(module);
            ...
            Color fadeColor = switch (hud.colorMode.getProperty()) {
                ...
                default -> ColorUtil.interpolateColorsBackAndForth(
                        ...
                        Samsara.getInstance().getSecondColor(), false
                );
            };
            ...
            if (fullOutline.getProperty()) {
                ...
                for (int i = currentIndex + 1; i < moduleEntries.size(); i++) {
                    ...
                    if (nextEntry.module().isToggled() && !nextEntry.module().isHidden()) {
                        Animation nextAnim = Samsara.getInstance().getAnimationManager().getAnimation(nextEntry.module());

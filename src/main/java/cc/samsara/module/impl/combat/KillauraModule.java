...
public class KillauraModule extends Module {
    ...
    public void onTick(TickEvent event) {
     ...
     /*   if (Samsara.getInstance().getModuleManager().getModule(BreakerModule.class).isToggled() &&
                Samsara.getInstance().getModuleManager().getModule(BreakerModule.class).rotate) {
            setBlockState(false);
            return;
        }*/
    ...
    private void handleCombat() {
        ...
        if (distance <= rotationRange.getProperty().floatValue() && rotation.getProperty()/* &&
                !(Samsara.getInstance().getModuleManager().getModule(BreakerModule.class).isToggled() &&
                        Samsara.getInstance().getModuleManager().getModule(BreakerModule.class).rotate)*/) {

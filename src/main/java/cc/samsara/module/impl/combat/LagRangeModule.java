...
public class LagRangeModule extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        BlinkComponent blinkComponent = Samsara.getInstance().getComponentManager().getComponent(BlinkComponent.class);
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        Render3DUtil.drawBoxESP(event.getMatricies(), box.inflate(0.08), Samsara.getInstance().getFirstColor(), 150);
    }
}

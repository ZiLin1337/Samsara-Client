...
import cc.samsara.module.impl.player.NoPushModule;
...
public abstract class MixinLivingEntity extends Entity implements ILivingEntity {
    ...
    private float redirectYRotForMoveFix(LivingEntity entity) {
        if ((Object) this == Minecraft.getInstance().player) {
            ...
            Samsara.getInstance().getEventManager().call(jumpCorrectionEvent);
    ...
    private int modifyHandSwingDuration(int constant) {
        final AnimationModule module = Samsara.getInstance().getModuleManager().getModule(AnimationModule.class);
    ...
    private void onPushAwayFrom(Entity other, CallbackInfo ci) {
        final NoPushModule noPush = Samsara.getInstance().getModuleManager().getModule(NoPushModule.class);

...
import static cc.samsara.skija.utils.SkijaHelperUtil.getUiScale;
...
public final class FontRenderer {
    ...
    public FontRenderer(final String name, final float size) {
        ...
        Typeface tf;
        try (InputStream in = FontRenderer.class.getResourceAsStream("/assets/samsara/fonts/" + name + ".ttf")) {

package cc.samsara.render.shader;
...
public class Shader {
    ...
    public Shader(String vertSource, String fragSource) {
        ...
        GlStateManager.glShaderSource(vert, vertSource);
        ...
        GlStateManager.glShaderSource(frag, fragSource);
    ...
    /**
     * Create shader from resource paths relative to assets/<namespace>/shaders/.
     */
    public static Shader fromResources(String namespace, String vertPath, String fragPath) {
        return new Shader(
            readResource(namespace, "shaders/" + vertPath),
            readResource(namespace, "shaders/" + fragPath)
        );
    }

    /**
     * Read shader source from Minecraft resource system.
     */
    ...
    public void set(String name, boolean v) {
        ShaderHelper.uniformInt(getLocation(name), v ? 1 : 0);
    }

package cc.samsara.event;

import cc.samsara.Samsara;
import cc.samsara.event.events.Event;
import cc.samsara.event.events.EventStoppable;
...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see cc.samsara.event.types.Priority
    ...
    public final Event call(final Event event) {
        if ((Minecraft.getInstance().player == null || Minecraft.getInstance().level == null) && !(Minecraft.getInstance().screen instanceof AltManagerScreen)) {
            if (Samsara.getInstance().getModuleManager() != null && Samsara.getInstance().getModuleManager().getModule(BackTrackModule.class) != null)
                Samsara.getInstance().getModuleManager().getModule(BackTrackModule.class).flushDelayedPackets();
            return event;
        }

...
import cc.samsara.ui.screens.clickgui.dropdown.impl.TabComponent;
...
public class DropdownCGUIScreen extends Screen implements IAccess {
    ...
    private static class ClickAnimation {
        ...
        public ClickAnimation(float x, float y) {
            this.x = x;
            this.y = y;
            this.color = Samsara.getInstance().getFirstColor();
            this.secondaryColor = Samsara.getInstance().getSecondColor();

package cc.samsara.ui.screens.altmanager.login.guis;
...
import cc.samsara.ui.screens.altmanager.microsoft.MicrosoftClient;
import cc.samsara.ui.screens.altmanager.microsoft.MicrosoftClientIDs;
import cc.samsara.ui.screens.altmanager.microsoft.MicrosoftLogin;
import cc.samsara.ui.widgets.CustomButtonWidget;
import cc.samsara.util.network.AccountUtil;
import cc.samsara.util.network.BrowserUtil;
import cc.samsara.util.render.ImguiUtil;
import imgui.ImGui;
import java.awt.*;
import java.io.File;
                ...
                (button) -> {
                    ...
                    try {
                        ...
                        if (clipboardText == null || clipboardText.isEmpty()) {
                            Samsara.LOGGER.error("Clipboard is empty");
                            return;
                        }
            ...
            if (fileExplorerWindow.getSelectedFile() != null && fileExplorerWindow.isShouldClose()) {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Samsara.LOGGER.error("Cookie login failed", e);
                    }

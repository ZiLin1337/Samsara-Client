...
public class ImGuiImpl {
    ...
    private static void loadMainFont(ImGuiIO io) {
        try (InputStream is = ImGuiImpl.class.getResourceAsStream("/assets/samsara/fonts/Product Sans Regular.ttf")) {
            if (is != null) {
    ...
    private static void loadFontAwesome(ImGuiIO io) {
        try (InputStream is = ImGuiImpl.class.getResourceAsStream("/assets/samsara/fonts/fontawesome-webfont.ttf")) {
            if (is != null) {
                byte[] fontData = is.readAllBytes();

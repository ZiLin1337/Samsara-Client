...
public class ClickGuiWindow extends Screen implements IAccess {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ClickGuiModule clickGuiModule = Samsara.getInstance().getModuleManager().getModule(ClickGuiModule.class);
        ...
        ImGuiImpl.draw(io -> {
            ...
            if (!currentTab.equals("Configs") && category != null) {
                ...
                for (Module module : Samsara.getInstance().getModuleManager().getModulesFromCategory(category)) {

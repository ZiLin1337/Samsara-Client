...
import cc.samsara.module.impl.visual.ClickGuiModule;
...
/*    public static int loadTexture(String path, String textureName) {
        ...
        try {
            Identifier identifier = IdentifierAccessor.createIdentifier("samsara", path);
    ...
    public static void setDarkMode(boolean invisibleButtonBg, float spacing, int alpha) {
        ...
        int cherryColor = ColorUtil.getSwap(Samsara.getInstance().getModuleManager()
                .getModule(ClickGuiModule.class) == null ? Color.blue :Samsara.getInstance().getModuleManager()

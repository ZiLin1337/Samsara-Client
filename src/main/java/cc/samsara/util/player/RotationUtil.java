package cc.samsara.util.player;
...
public class RotationUtil implements IAccess {
    ...
    public static Vec3 getHitVec3(Entity entity) {
        ...
        float size = Samsara.getInstance().getModuleManager().getModule(RotationsModule.class).oldHitBoxOffset.getProperty() ? 0.1F : 0.0F;
    ...
    public static Vec3 getPositionEyes() {
        float eyeHeight =
                Samsara.getInstance().getModuleManager().getModule(RotationsModule.class).modernHitVec.getProperty() ?

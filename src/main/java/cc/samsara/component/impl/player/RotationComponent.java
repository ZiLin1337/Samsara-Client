package cc.samsara.component.impl.player;
...
import cc.samsara.module.impl.movement.FlightModule;
...
public class RotationComponent extends Component {
    ...
    public void onTickInputEvent(InputTickEvent event) {
        if (!activate || rotations == null || !shouldMoveFix ||
                ...
                Samsara.getInstance().getModuleManager().getModule(FlightModule.class).isToggled() || !fixKeyBinds)
            return;
    ...
    public void onMotionEvent(MotionEvent event) {
        if (activate && rotations != null) {
            ...
            shouldMoveFix = Samsara.getInstance().getModuleManager().getModule(RotationsModule.class).movementCorrection.getProperty();

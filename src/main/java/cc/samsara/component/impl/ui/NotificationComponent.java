package cc.samsara.component.impl.ui;
...
import cc.samsara.ui.notifications.NotificationInfo;
...
public class NotificationComponent extends Component {
    ...
    public static void addNotification(NotificationInfo notificationInfo) {
       ...
       /* Identifier soundId = IdentifierAccessor.createIdentifier("samsara", "dancing-random");
    ...
    public void onRender2D(Render2DEvent event) {
        if (!Samsara.getInstance().getModuleManager().getModule(NotificationsModule.class).isToggled())
            return;
